...
import baonuoIcon from '@/assets/icons/baonuo.svg'
...
function methodIcon(type: string): string {
  ...
  if (type === 'baonuo') return METHOD_ICONS.baonuo
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'baonuo') return 'border-[#0D9488] bg-teal-50 text-gray-900 shadow-sm dark:border-[#2DD4BF] dark:bg-teal-950 dark:text-gray-100'
