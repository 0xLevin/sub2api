<template>
  <div v-if="!isDesktopViewport" class="space-y-3">
    <template v-if="loading">
      <div v-for="i in 5" :key="i" class="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-900">
        <div class="space-y-3">
    ...
    <template v-else-if="!data || data.length === 0">
      <div class="rounded-lg border border-zinc-200 bg-white p-12 text-center shadow-sm dark:border-dark-700 dark:bg-dark-900">
        <slot name="empty">
    ...
    <template v-else>
      <div
        ...
        class="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-900"
      >
        <div class="space-y-3">
          <div
  ...
  >
    <table class="w-full min-w-max divide-y divide-zinc-200 dark:divide-dark-700">
      <thead class="table-header bg-zinc-50 dark:bg-dark-800">
        <tr>
          <th
            ...
            scope="col"
            :class="[
              'sticky-header-cell py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-dark-400',
              getAdaptivePaddingClass(),
              { 'cursor-pointer hover:bg-zinc-100 dark:hover:bg-dark-700': column.sortable },
      ...
      <tbody class="table-body divide-y divide-zinc-100 bg-white dark:divide-dark-800 dark:bg-dark-900">
        <!-- Loading skeleton -->
        ...
        <template v-else>
          ...
          <tr
            ...
            :ref="measureElement"
            class="hover:bg-zinc-50 dark:hover:bg-dark-800"
          >
            <td
              v-for="(column, colIndex) in columns"
              :key="column.key"
              :class="[
                'whitespace-nowrap py-3 text-sm text-zinc-900 dark:text-zinc-100',
                getAdaptivePaddingClass(),
