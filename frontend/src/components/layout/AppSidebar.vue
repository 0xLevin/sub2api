<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <div class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-md bg-white shadow-sm">
        <img v-if="settingsLoaded" :src="siteLogo || '/logo.png'" alt="Logo" class="h-full w-full object-contain" />
      </div>
      <div class="sidebar-brand" :class="{ 'sidebar-brand-collapsed': sidebarCollapsed }" :aria-hidden="sidebarCollapsed ? 'true' : 'false'">
        <span class="sidebar-brand-title text-base font-semibold text-white">
          {{ siteName }}
        </span>
        <!-- Version Badge -->
        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <template v-if="item.children?.length">
              ...
              <!-- Children -->
              <div v-if="!sidebarCollapsed && isGroupExpanded(item)" class="mb-1 ml-4 border-l border-white/10 pl-2 dark:border-dark-600">
                <router-link
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-white/10 p-3 dark:border-dark-800">
      <!-- Theme Toggle -->
      <button
        @click="toggleTheme"
  ...
  <transition name="fade">
    <div v-if="mobileOpen" class="fixed inset-0 z-30 bg-black/45 lg:hidden" @click="closeMobile"></div>
  </transition>
</template>
