  ...
  admin: {
    ...
    accounts: {
      ...
      stats: {
        ...
        showSampleDetails: 'Show samples',
        hideSampleDetails: 'Hide samples',
        samples: 'samples',
        completeCycleFlag: 'Complete cycle',
        partialCycleFlag: 'Partial cycle',
    ...
    settings: {
      ...
      payment: {
        ...
        field_channelType: 'Channel Type',
        ...
        field_baonuoApiBaseHint: 'Default: https://baonuo.roseland.life. Enter the BaoNuo gateway origin only; do not include /api/newOrder or other endpoint paths.',
        field_paymentCurrencyHint: 'Default is CNY. Stripe, Airwallex, and BaoNuo can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, and EasyPay remain CNY.',
        ...
        baonuoWebhookHint: 'Configure the following URL as the async notify URL in BaoNuo merchant dashboard. Sub2API returns ok after verified callbacks.',
