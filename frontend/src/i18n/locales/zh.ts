  ...
  admin: {
    ...
    accounts: {
      ...
      stats: {
        ...
        sampleDetails: '样本细节',
        showSampleDetails: '展开样本',
        hideSampleDetails: '收起样本',
        samples: '个样本',
        completeCycleFlag: '完整周期',
        partialCycleFlag: '未完成周期',
    ...
    settings: {
      ...
      payment: {
        ...
        field_baonuoApiBaseHint: '默认 https://baonuo.roseland.life。请填写保诺网关域名，不需要包含 /api/newOrder 等接口路径。',
        field_paymentCurrencyHint: '默认 CNY。Stripe、Airwallex 和保诺支付可按账户支持从下拉项选择 HKD、USD 等币种；微信、支付宝、易支付仍按 CNY。',
        ...
        baonuoWebhookHint: '请在保诺商户后台将以下地址配置为异步通知地址；收到回调后系统会返回 ok。',
