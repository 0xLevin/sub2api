...
assert_line .github/workflows/fork-image.yml '            mkdir -p "${context_dir}/deploy" "${context_dir}/backend"'
assert_line .github/workflows/fork-image.yml '            cp -R backend/resources "${context_dir}/backend/resources"'
