...
type openAICodexUsageSnapshotRecorder interface {
	RecordOpenAICodexUsageSnapshot(ctx context.Context, accountID int64, snapshot *OpenAICodexUsageSnapshot) error
}
